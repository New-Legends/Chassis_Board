...
//底盘运动过程最大前进速度
#define NORMAL_MAX_CHASSIS_SPEED_X 1.0f //2.0
//底盘运动过程最大平移速度
#define NORMAL_MAX_CHASSIS_SPEED_Y 1.0f //1.5
//底盘运动过程最大旋转速度
...
//底盘旋转跟随PID
#define CHASSIS_FOLLOW_GIMBAL_PID_KP 17.0f//8.0f
#define CHASSIS_FOLLOW_GIMBAL_PID_KI 0.0f
#define CHASSIS_FOLLOW_GIMBAL_PID_KD 195.0f
